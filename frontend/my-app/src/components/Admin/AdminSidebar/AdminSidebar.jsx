  ...
  return (
    <aside className="admin-sidebar">
      ...
      <nav className="sidebar-menu">
        <NavLink to="/admin" className="menu-item active">
        ...
        */}
        ...
        <NavLink to="/admin/register" className="menu-item">
          <img src={listIcon} alt="List" className="menu-icon" />
          <span className="menu-text">상품등록</span>
          <img src={SVG} alt=">" className="arrow-icon" />
        </NavLink>
        ...
        */}
        ...
        <NavLink to="/admin/order-list" className="menu-item">
