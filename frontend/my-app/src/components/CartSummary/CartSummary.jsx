  ...
  return (
    <div className={styles.orderSummary}>
      ...
      <div className={styles.summaryBody}>
        <span className={`${styles.operator} ${styles.op_minus}`}>-</span>
        <span className={`${styles.operator} ${styles.op_plus}`}>+</span>
        <span className={`${styles.operator} ${styles.op_equals}`}>=</span>
