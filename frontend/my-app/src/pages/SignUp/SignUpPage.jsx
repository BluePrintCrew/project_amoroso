...
const SignUpPage = () => {
  ...
  useEffect(() => {
    ...
    const token =
      queryParams.get("token") || localStorage.getItem("access_token");
    const provider =
      queryParams.get("provider") || localStorage.getItem("social_provider");
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="elevator-section">
              ...
              <div className="elevator-options">
                <div
                  className={`elevator-option ${
                    elevatorType === "ONE_TO_SEVEN" ? "selected" : ""
                  }`}
                ...
                <div
                  className={`elevator-option ${
                    elevatorType === "EIGHT_TO_TEN" ? "selected" : ""
                  }`}
                ...
                <div
                  className={`elevator-option ${
                    elevatorType === "ELEVEN_OR_MORE" ? "selected" : ""
                  }`}
            ...
            {isNewUser && (
              <div className="agreement-section">
                ...
                <div className="agreement-introduction">
                  Amoroso 서비스 통합이용약관, 개인정보 수집 및 이용, 위치정보
                  이용약관(선택), 마케팅 수신(선택)에 모두 동의합니다. 선택항목
                  동의를 거부하셔도 서비스 이용이 가능합니다.
                </div>
                <div className="agreement-item">
                  <input
                    type="checkbox"
            ...
            <div className="agreement-item-marketing">
              ...
              <p className="marketing-description">
                Amoroso에서 제공하는 정보 등을 받으실 수 있습니다. 단, 상품
                구매정보는 수신동의 여부에 관계없이 발송됩니다.
              </p>
            </div>
            ...
            <div className="button-group">
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? "처리 중..." : isNewUser ? "가입완료" : "정보수정"}
              </button>
            </div>
          </form>
        </div>
